...
//*******************Receive*******************//
//**********VCU***********//
extern unsigned char VCU_WorkMode;
extern unsigned char GearPosition;
extern int GasPedalPosition;
extern int BrakePedalPosition;
extern double Speed;
extern unsigned char MiddleDoorState;
extern unsigned char ButtonState;
extern unsigned char RotationSpdDir;
extern unsigned char VCU_State;
extern unsigned char FrontDoor;
extern unsigned char Horn;
extern unsigned char VCU_Accelaration;
extern unsigned char EPB_State;

//**********VCU2**********//
extern unsigned char Bfog_Lamp;
extern unsigned char Small_Lamp;
extern unsigned char High_Beam;
extern unsigned char Low_Beam;
extern unsigned char Left_Lamp;
extern unsigned char Right_Lamp;
extern unsigned char Fog_Lamp;
extern unsigned char Hazard_Lamp;
extern unsigned char Stop_Lamp;

//**********EPS***********//
extern unsigned char EPS_State;
extern int EPS_ActualAngle;
extern double EPS_ActualTorque;
extern unsigned char EPS_ControlState;

//**********EBS***********//
extern double Flwheelspeed;
extern double Frwheelspeed;
extern double Blwheelspeed;
extern double Brwheelspeed;
extern double AccurateSpeed;
//*******************Receive*******************//

//*******************Send*******************//
extern unsigned char throttle;
extern double fDeFLRWheelAverAngle;
extern double brake;
extern unsigned char HighBeam_turnedon;
extern unsigned char LowBeam_turnedon;
extern unsigned char leftlamp_turnedon;
extern unsigned char rightlamp_turnedon;
extern unsigned char shift;			    //档位，
extern bool lateralctrl_enabled;			//横向控制有效
extern bool longitutdectrl_enabled;	    //纵向控制有效
extern unsigned char Door_Control;
extern unsigned char Bfog_Lamp_turnedon;
extern unsigned char Small_Lamp_turnedon;
extern unsigned char Fog_Lamp_turnedon;
extern unsigned char Hazard_Light_turnedon;
extern unsigned char Stop_Lamp_turnedon;

extern unsigned char Horn_turnedon;
extern unsigned char FrontDoor_turnedon;
//CAN错误码
enum CAN_ErrorCode
{
...
typedef  struct  tagCAN_DataFrame{
    ...
    BYTE	bRemoteFlag;                    // 是否是远程帧,0是数据帧，1是远程帧
    BYTE	bExternFlag;                    // 是否是扩展帧，0是标准帧，1是扩展帧
    BYTE	nDataLen;                       // 数据长度 <=8
    UINT	uID;                            // 报文DI
